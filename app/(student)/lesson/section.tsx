      ...
      >
        ...
        >
          ...
          <Pressable
            ...
            style={{
              ...
              padding: 16,
              backgroundColor:
                currentItemIndex === items.length - 1 ? "#f8f9fa" : "#fff",
              borderRadius: 12,
              borderWidth: 1,
              borderColor:
                currentItemIndex === items.length - 1 ? "#dee2e6" : "#e9ecef",
          ...
          >
            <Text
              style={{
                ...
                fontWeight: "600",
                color:
                  currentItemIndex === items.length - 1 ? "#6c757d" : "#212529",
              }}
            >
              Next →
            </Text>
        ...
        {!allItemsViewed && (
          ...
          >
            ...
            >
              View all {items.length} items to complete section (
